...
namespace WinterWorkShop.Cinema.Domain.Common
{
    public class Database
    {
        ...
        {
            new ProjectionModel { Id = 1, Name = "Spuderman", BrojSale = 1, DateTime = new DateTime() , Description = "film1"},
            new ProjectionModel { Id = 2, Name = "Spuderman 2", BrojSale = 1, DateTime = new DateTime() , Description = "film2"},
            new ProjectionModel { Id = 3, Name = "Spuderman 3", BrojSale = 1, DateTime = new DateTime() , Description = "film3"}
        };
    }
}
